            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-yellow-700">
                  By using BlogIt, you agree to these terms. Please read them carefully as they affect your legal rights.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing or using BlogIt ("the Service"), you agree to be bound by these Terms of Service 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Users are responsible for the content they post. We do not claim ownership of your content, 
                but you grant us a license to display and distribute it on our platform.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                The BlogIt platform, including its original content, features, and functionality, 
                is owned by BlogIt and is protected by international copyright, trademark, and 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                In no event shall BlogIt, nor its directors, employees, partners, agents, suppliers, 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                We will provide notice of significant changes through our platform or via email.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                ...
                <br />
                <a href="mailto:legal@blogit.com" className="text-green-600 hover:text-green-700">
                  legal@blogit.com
                </a>
              </p>
            </section>
