        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4 group">
              <span className="text-green-400 font-bold text-3xl group-hover:text-green-300 transition-colors">
                ₿
              </span>
              <span className="text-xl font-bold group-hover:text-green-400 transition-colors">
                BlogIt
              </span>
            </Link>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-4">
              Your premier destination for insightful articles, tutorials, and
