      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-white/70">For the best articles around.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a className="hover:text-red-500 transition">Register</a>
              </li>
              <li>
                <a className="hover:text-red-500 transition">Login</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a className="hover:text-green-500 transition">FAQs</a>
              </li>
              <li>
                <a className="hover:text-green-500 transition">Help Center</a>
              </li>
              <li>
                <a className="hover:text-green-500 transition">Contact Us</a>
              </li>
            </ul>
          </div>
