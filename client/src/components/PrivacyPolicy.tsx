          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-yellow-700 text-sm">
                  BlogIt may disclose your Personal Data in the good faith
                  belief that such action is necessary to comply with a legal
                  obligation, protect and defend the rights or property of
                  BlogIt, prevent or investigate possible wrongdoing, protect
                  the personal safety of users, or protect against legal
                  liability.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                ...
                <br />
                <a
                  href="mailto:privacy@blogit.com"
